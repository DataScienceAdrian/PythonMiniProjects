...
pygame.init()
pygame.display.set_caption("Snake Python v. 0.1")
pygame.font.init()
random.seed()
...
background_color = pygame.image.load("tlo_python.jpg")
#background_color = pygame.Color(114,137,218)
...
def main():
    score = 0
    pygame.mixer.music.load("Husky.mp3")
    ...
    while (endgame != 1):
        ...
        # Drawing
        screen.blit(background_color,(-550,-250))
        for myApple in apples:
            if (myApple.state == 1):
                myApple.draw(screen)
